...
public class StartPanel extends JPanel implements ActionListener {
  ...
  public StartPanel(CelebrityGame controllerRef) {
    ...
    celebrityRadio = new JRadioButton("Food");
    celebrityClue = "Enter the clue for the food";
    clueLabel = new JLabel(celebrityClue);

    answerField = new JTextField("Type food here (4 letters min)");
    clueField = new JTextField("Enter food clue here (10 letters min)");
